 ...
 */
class Event<T>(private val content: T) { // T - message (error) and data
    ...
    companion object{
        ...
        // Note Event constructor takes non-nullable data, if data is nullable, use these fns to get Event object
